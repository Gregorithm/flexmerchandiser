import 'dart:convert';
import 'package:flexmerchandiser/features/screens/existingcustomerchamaonboard/registerchama.dart';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data["data"] is Map &&
          ...
          setState(() {
           averagePayment =
                paymentSummary?["average_payment"]?.toString() ?? "N/A";
            customerCategory =
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: screenWidth * 0.02),
                  ...
                  children: [
                    Text(
                      "Average Customer Payment: \Kshs ${double.tryParse(averagePayment ?? '0')?.toStringAsFixed(2) ?? 'N/A'}",
                      style: GoogleFonts.montserrat(
                    ...
                    Container(
                      ...
                      child: FractionallySizedBox(
                        ...
                        widthFactor: ((double.tryParse(averagePayment ?? '0') ?? 0) / 1000).clamp(0.0, 1.0), // Adjust max limit
                        child: Container(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(5),
                            color: Colors.green,
