...
class RegisterNewChamaCustomer extends StatefulWidget {
  @override
  _RegisterNewChamaCustomerState createState() =>
      _RegisterNewChamaCustomerState();
}

class _RegisterNewChamaCustomerState extends State<RegisterNewChamaCustomer> {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField("Last Name", "Enter Last Name", lastNameController,
                screenWidth, cardColor, textColor, hintTextColor),
            ...
            Row(
              children: [
                _buildGenderOption(
                    "Male", Icons.male, Colors.blue, screenWidth, textColor),
                SizedBox(width: 10),
  ...
  Widget _buildGenderOption(String gender, IconData icon, Color color,
      double screenWidth, Color textColor) {
    return Expanded(
