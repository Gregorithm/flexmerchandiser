...
class _HomeScreenState extends State<HomeScreen> {
  void debugPrintDatabase() {
    ...
    // Add your database debugging logic here if needed.
  }
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(isOnline
                  ? "No outlets found after syncing!"
                  : "No outlets found locally. Connect to the internet to sync data.")),
        );
      }
    } catch (e) {
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      _buildProgressIndicator(
                                          ...
                                          isDarkMode),
                                      SizedBox(width: 10),
                                      _buildProgressIndicator(Colors.red, "29",
                                          "Not in Flexchama", isDarkMode),
                                    ],
                                  ),
                                ],
                              ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text("To get you started",
                                      style: _titleStyle(isDarkMode)),
                                  Text(
                                      "Here are Outlets we picked just for you",
                                      ...
                                      : outlets.isEmpty
                                          ...
                                          : GridView.builder(
                                              ...
                                              gridDelegate:
                                                ...
                                                mainAxisSpacing: 19,
                                                childAspectRatio: 4 /
                                                    4, // Controls aspect ratio of cards
                                              ),
                                                    ...
                                                    decoration: BoxDecoration(
                                                      ...
                                                      image: DecorationImage(
                                                        image: AssetImage(
                                                            imageUrl),
                                                        fit: BoxFit
                                                            .cover, // Ensures image fills entire card
                                                      ),
                                                    ),
                                                    child: Stack(
                                                      children: [
...
Widget _buildCardOutletsContainer(
...
Widget _buildProgressIndicator(
    Color color, String value, String label, bool isDarkMode) {
  return Expanded(
    child: Column(
...
TextStyle _titleStyle(bool isDarkMode) => GoogleFonts.montserrat(
    fontSize: 18,
    fontWeight: FontWeight.bold,
    color: isDarkMode ? Colors.white : Colors.black);
TextStyle _subtitleStyle(bool isDarkMode) => GoogleFonts.montserrat(
    fontSize: 16,
    fontWeight: FontWeight.bold,
    color: isDarkMode ? Colors.white70 : Colors.black);
TextStyle _textStyle(bool isDarkMode) => GoogleFonts.montserrat(
